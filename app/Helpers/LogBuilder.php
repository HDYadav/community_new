...
//  Log Builder class to generate the logs
//
//  who             date        description
//  Hari Yadav    13-10-2023    created
...
class LogBuilder{
    ...
    public static function careToken($logLevel="", $data="", $moduleName="") {
        self::removeKeys($data);
        self::log('care', $logLevel, $data, $moduleName);
    }
